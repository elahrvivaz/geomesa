...
object Z3SFC extends SpaceFillingCurve[Z3] {
  ...
  private[curve] val xprec: Long = math.pow(2, 21).toLong - 1
  private[curve] val yprec: Long = math.pow(2, 21).toLong - 1
  ...
  override def ranges(x: (Double, Double),
    ...
    ZRange.zranges(index(x._1, y._1, t._1), index(x._2, y._2, t._2), precision)
