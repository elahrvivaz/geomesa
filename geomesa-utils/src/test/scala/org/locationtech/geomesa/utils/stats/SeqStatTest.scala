...
class SeqStatTest extends Specification with StatTestHelper {
  ...
  "Seq stat" should {
    ...
    "be empty initiallly" >> {
      ...
      val ic = stat.stats(1).asInstanceOf[IteratorStackCounter]
      val eh = stat.stats(2).asInstanceOf[EnumeratedHistogram[java.lang.Long]]
    ...
    "combine two SeqStats" >> {
      ...
      val ic2 = stat2.stats(1).asInstanceOf[IteratorStackCounter]
      val eh2 = stat2.stats(2).asInstanceOf[EnumeratedHistogram[java.lang.Long]]
