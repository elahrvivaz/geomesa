...
class RangeHistogramTest extends Specification with StatTestHelper {
  ...
  "RangeHistogram stat" should {
    ...
    "work with strings" >> {
      ...
      val lowerIndex = rh.bins.indexOf(lowerEndpoint)
      val middleIndex = rh.bins.indexOf(midpoint)
      ...
      "serialize and deserialize" >> {
        val packed   = StatSerializer(sft).serialize(rh)
        val unpacked = StatSerializer(sft).deserialize(packed).asInstanceOf[RangeHistogram[String]]
    ...
    "work with integers" >> {
      ...
      "serialize and deserialize" >> {
        val packed   = StatSerializer(sft).serialize(rh)
        val unpacked = StatSerializer(sft).deserialize(packed).asInstanceOf[RangeHistogram[java.lang.Integer]]
    ...
    "work with longs" >> {
      ...
      val lowerIndex = rh.bins.indexOf(lowerEndpoint)
      val middleIndex = rh.bins.indexOf(midpoint)
      val upperIndex = rh.bins.indexOf(upperEndpoint)
      ...
      "serialize and deserialize" >> {
        val packed   = StatSerializer(sft).serialize(rh)
        val unpacked = StatSerializer(sft).deserialize(packed).asInstanceOf[RangeHistogram[java.lang.Long]]
    ...
    "work with floats" >> {
      ...
      "serialize and deserialize" >> {
        val packed   = StatSerializer(sft).serialize(rh)
        val unpacked = StatSerializer(sft).deserialize(packed).asInstanceOf[RangeHistogram[java.lang.Float]]
    ...
    "work with doubles" >> {
      ...
      "serialize and deserialize" >> {
        val packed   = StatSerializer(sft).serialize(rh)
        val unpacked = StatSerializer(sft).deserialize(packed).asInstanceOf[RangeHistogram[java.lang.Double]]
    ...
    "work with dates" >> {
      ...
      "serialize and deserialize" >> {
        val packed   = StatSerializer(sft).serialize(rh)
        val unpacked = StatSerializer(sft).deserialize(packed).asInstanceOf[RangeHistogram[Date]]
    ...
    "work with geometries" >> {
      ...
      "serialize and deserialize" >> {
        val packed   = StatSerializer(sft).serialize(rh)
        val unpacked = StatSerializer(sft).deserialize(packed).asInstanceOf[RangeHistogram[Geometry]]
