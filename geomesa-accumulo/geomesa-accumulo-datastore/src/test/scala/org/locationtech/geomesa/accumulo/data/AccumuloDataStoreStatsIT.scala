...
class AccumuloDataStoreStatsIT extends TestWithFeatureTypes {
  ...
  "AccumuloDataStore" should {
    "track stats for ingested features" >> {
      ...
      "estimate counts for schemas without a date" >> {
        ...
        val reader = ds.getFeatureReader(new Query(AccumuloDataStoreStatsIT.this.sftName), Transaction.AUTO_COMMIT)
