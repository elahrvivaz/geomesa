...
class XZConfigurationIT extends TestWithFeatureType {

  override val spec =
    "name:String,dtg:Date,*geom:Polygon:srid=4326;geomesa.xz.precision='10',geomesa.indexes.enabled='xz2,xz3'"
