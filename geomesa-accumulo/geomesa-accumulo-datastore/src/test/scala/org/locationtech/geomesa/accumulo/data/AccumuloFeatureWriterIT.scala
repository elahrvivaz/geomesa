...
class AccumuloFeatureWriterIT extends TestWithFeatureType with BeforeEach {

  override def before: Any = clearTablesHard()

  sequential

  override val spec = "name:String:index=join,age:Integer,dtg:Date,geom:Point:srid=4326"
