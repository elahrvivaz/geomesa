...
class CoveringAttributeIndexIT extends TestWithFeatureType {
  ...
  "AttributeIndexStrategy" should {
    ...
    "support full coverage of attributes" in {
      ...
      features.head.getAttribute("name") mustEqual "3name3"
      features.head.getAttribute("age") mustEqual 3
      features.head.getAttribute("weight") mustEqual 6.0
      features.head.getAttribute("height") mustEqual 9.0
      features.head.getAttribute("dtg").toString must contain("Jan 13")
    }
    ...
    "support transforms in fully covered indices" in {
      ...
      features.head.getAttribute("name") mustEqual "3name3"
      features.head.getAttribute("age") mustEqual 3
      features.head.getAttribute("weight") must beNull
      features.head.getAttribute("height") must beNull
      features.head.getAttribute("dtg").toString must contain("Jan 13")
    }
    ...
    "support ecql filters and covering transforms in fully covered indices" in {
      ...
      features must haveSize(1)
      features.head.getAttribute("name") mustEqual "3name3"
      features.head.getAttribute("age") must beNull
      features.head.getAttribute("weight") must beNull
      features.head.getAttribute("height") mustEqual 9.0
      features.head.getAttribute("dtg").toString must contain("Jan 13")
    }
    ...
    "support join coverage of attributes" in {
      ...
      features must haveSize(1)
      features.head.getAttribute("name") mustEqual "5name5"
      features.head.getAttribute("age") mustEqual 5
      features.head.getAttribute("weight") mustEqual 10.0
      features.head.getAttribute("height") mustEqual 15.0
      features.head.getAttribute("dtg").toString must contain("Jan 15")
    }
    ...
    "be backwards compatible with index spec" in {
      ...
      features must haveSize(1)
      features.head.getAttribute("name") mustEqual "2name2"
      features.head.getAttribute("age") mustEqual 2
      features.head.getAttribute("weight") mustEqual 4.0
      features.head.getAttribute("height") mustEqual 6.0
      features.head.getAttribute("dtg").toString must contain("Jan 12")
    }
  }
}
