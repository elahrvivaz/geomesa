...
class AccumuloDataStoreIT extends TestWithFeatureTypes {
  ...
  "AccumuloDataStore" should {
    ...
    "Provide a feature update implementation" in {
      ...
      addFeatures(Seq.tabulate(6) { i =>
        ScalaSimpleFeature.create(sft, i.toString, i, "2012-01-02T05:06:07.000Z", "POINT(45.0 45.0)")
      })
