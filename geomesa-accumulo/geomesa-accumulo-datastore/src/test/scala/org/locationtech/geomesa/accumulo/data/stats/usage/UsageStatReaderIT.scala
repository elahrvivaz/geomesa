...
class UsageStatReaderIT extends TestWithMiniCluster {
  ...
  lazy val writer = new AccumuloEventWriter(connector, statsTable)
  lazy val reader = new AccumuloEventReader(connector, statsTable)
